<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="entreprise" class="block mt-1 w-full" type="text" name="entreprise" :value="old('entreprise')" required autocomplete="entreprise" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('Confirmer mot de psse')" />
