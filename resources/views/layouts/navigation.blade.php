        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <div class="flex items-center mr-3 ">
                    <a href="https://l-assistant-digital.com/#ed-167065524" aria-label="Assistance"target="_blank">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden ">
            ...
            <div class="">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('profile.edit')" style="color: white; background-color: #268EE6;   text-decoration: none;">
                        {{ __('Profil') }}
                    </x-responsive-nav-link>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-responsive-nav-link :href="route('logout')" style="color: white; background-color: #268EE6;   text-decoration: none;"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                            {{ __('Se déconnecter') }}
                        </x-responsive-nav-link>
