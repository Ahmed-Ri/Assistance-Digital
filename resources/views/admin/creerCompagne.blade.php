    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
            ...
            <div class="row">
                <div class="Col-12 col-lg-6 offset-lg-3">
                    <div class="form-wrapper py-5">
                        <!-- form starts -->
                        <form action="{{ route('admin.users.storeCampaign', $user->id) }}" name="demoform" id="demoform" method="POST"
                            ...
                            <div class="form-group row ">
                                <label for="status" class="col-6 col-form-label fw-bold ">Statut:</label>
                                <div class="col-sm-8">
        ...
        <script>
            ...
            var myDropzone = new Dropzone("#demoform", {
                url: "{{ route('admin.users.storeCampaign', $user->id) }}",
